...
## Project Structure
    ...
    ├── deploytesting_dev_26480  # Django project configurations
...
1. Clone this repo and `cd deploytesting_dev_26480`
...
2. Clone this repo and `cd deploytesting_dev_26480`
